...
@pytest.mark.parametrize("category_id, expected_response",[
    (9, [
        {'id': 24, 'parent_id': 9, 'category_name': 'Рейки', 'image_url': None, 'has_children': False}, 
        {'id': 25, 'parent_id': 9, 'category_name': 'Бруски', 'image_url': None, 'has_children': False}, 
        {'id': 26, 'parent_id': 9, 'category_name': 'Доски', 'image_url': None, 'has_children': False}
    ]),
    (0, []),(-1, []),(99, [])
])
