...
@pytest.mark.parametrize(
    ...
    [(6, "Брусок строганый 40x40x3000 мм хвоя сорт"), (1, None), (2, None)],
)
@pytest.mark.asyncio
...
async def test_add_prdct_and_find_prdct_in_cart():
    await CartsDAO.add_data(product_id=1, quantity=10, price=100, user_id=1)
...
@pytest.mark.parametrize("product_id, user_id", [(2, 3)])
@pytest.mark.asyncio
...
@pytest.mark.parametrize("product_id, user_id", [(2, 5)])
@pytest.mark.asyncio
