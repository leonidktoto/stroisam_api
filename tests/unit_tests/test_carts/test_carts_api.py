...
test_data = [
    ({"product_id": 0, "quantity": 0}, 404),
    ({"product_id": 1, "quantity": 1}, 200),
    ({"product_id": "test", "quantity": "test"}, 422),
    ({"product_id": 1, "quantity": "test"}, 422),
    ({"product_id": "test", "quantity": 1}, 422),
]
...
@pytest.mark.parametrize("product, status_code", test_data)
@pytest.mark.asyncio
...
@pytest.mark.parametrize("id, status_code", [(1, 204), (0, 204), ("1", 204), ("sdas", 422)])
@pytest.mark.asyncio
