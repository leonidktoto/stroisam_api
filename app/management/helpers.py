...
def load_images_to_s3(
    file: UploadFile, file_dir: str, product_id: int | None = None
) -> str | list[str]:
    try:
        if file.filename:
        ...
        sizes = {"small": (150, 150), "medium": (600, 600), "large": (1200, 1200)}
        ...
        for size_name, size in sizes.items():
            ...
            if product_id:
                ...
                image_dir_list.append(
                    f"{settings.ENDPOINT_URL}/{settings.BUCKET_NAME}/{dir_image}_{size_name}.jpeg"
                )
